...
##############################################################
#Set your paths here
def feathering(path_given):
#path to provided foreground images
    fg_path = 'static/Feathering/fg/'

    #path to provided alpha mattes
    a_path = 'static/Feathering/alpha/'

    #Path to background images (MSCOCO)
    bg_path = path_given + "/"

    #Path to folder where you want the composited images to go
    out_path = 'static/merged/'
    ...
    for i in  bg_files:
        ...
        im_name = random.choice([im_name for im_name in fg_files])
        ...
        for i in range(num_bgs):
            ...
            out.save(out_path + "output" + '.png', "PNG")        
            print("a")
            bcount += 1

#feathering("/home/riya/Desktop/ezdz-master/flask_test/static/Inpainting-Simple") 